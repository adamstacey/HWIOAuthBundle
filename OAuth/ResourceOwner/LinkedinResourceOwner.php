...
class LinkedinResourceOwner extends GenericOAuth2ResourceOwner
{
    ...
    protected function configureOptions(OptionsResolver $resolver)
    {
        ...
        $resolver->setDefaults(array(
            ...
            'infos_url'                => 'https://api.linkedin.com/v1/people/~:(id,first-name,last-name,formatted-name,email-address,picture-urls::(original),public-profile-url,date-of-birth)?format=json',
